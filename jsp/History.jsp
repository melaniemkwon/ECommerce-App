  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="History">Transaction</a></li>
	...
	<div class="container">
		...
		<tr>
			<th>ID</th><th>Purchased Items</th><th>Total Price</th>
		</tr>
		<c:forEach items="${transactionHistory}" var="items">
			<tr><td>${items.id }</<td><td>${items.items }</td><td> $ ${items.price }.00</td></tr>
